...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.c_attn = nn.Linear(config.n_embd, 3 * config.n_embd)  # E -> Q, K, V
        self.c_proj = nn.Linear(config.n_embd, config.n_embd)  # V -> E
    ...
    def forward(self, x):
        ...
        q, k, v = qkv.split(self.n_embd, dim=2)  # split the 3*E into 3 parts  # (B, T, E) each
...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        # Convert to LongTensor for safety
        idx = idx.long()
    ...
    def generate(self, tokens, n=10, topk=50, temperature=1.0):
        ...
        for i in range(n):
            ...
            topk_probs, topk_indices = torch.topk(probs, topk, dim=-1)  # (B, k)
            # Sample
...
if __name__ == '__main__':
    ...
    # generated = [tokenizer.decode(g.tolist()) for g in generated]
    # print(generated)
